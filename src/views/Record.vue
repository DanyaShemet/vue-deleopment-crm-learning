    ...
    <form class="form" v-else @submit.prevent="submitHandler">
      ...
      <div class="input-field">
        ...
        <span
                ...
                v-if="$v.description.$dirty && !$v.description.required">{{'Message_EnterDescription'|localize}}</span>
      </div>
        ...
        methods: {
            async submitHandler() {
                ...
                if (this.canCreateRecord) {
                    ...
                    this.$message(`Недастаточно средств на счете (${this.amount - this.info.bill})`)
                }
